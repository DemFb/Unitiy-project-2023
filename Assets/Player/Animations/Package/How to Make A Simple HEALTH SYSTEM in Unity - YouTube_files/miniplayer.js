...
V:[{I:"path",X:{d:"M19,19 L5,19 L5,5 L12,5 L12,3 L5,3 C3.89,3 3,3.9 3,5 L3,19 C3,20.1 3.89,21 5,21 L19,21 C20.1,21 21,20.1 21,19 L21,12 L19,12 L19,19 Z M14,3 L14,5 L17.59,5 L7.76,14.83 L9.17,16.24 L19,6.41 L19,10 L21,10 L21,3 L14,3 Z",fill:"#fff","fill-rule":"nonzero"}}]}]}]}]});this.J=a;this.Ta("click",this.onClick,this);this.updateValue("title",g.dU(a,"Agrandir","i"));this.update({"data-title-no-tooltip":"Agrandir"});this.addOnDisposeCallback(g.bU(b.Jd(),this.element))},arb=function(a){g.V.call(this,
{I:"div",
...
Ma:["ytp-miniplayer-close-button","ytp-button"],X:{"aria-label":"Fermer"},V:[g.dG()]});g.L(this,a);a.Da(this.hJ.element);this.T(a.element,"click",this.Rp);a=new g.V({I:"button",Ma:["ytp-miniplayer-replay-button","ytp-button"],X:{"aria-label":"Fermer"},V:[g.Qva()]});g.L(this,a);a.Da(this.hJ.element);this.T(a.element,"click",this.h$);this.T(this.player,"presentingplayerstatechange",this.Rd);this.T(this.player,"appresize",this.Hb);this.T(this.player,"fullscreentoggled",this.Hb);this.Hb()};
